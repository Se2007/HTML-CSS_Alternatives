...
// node_modules/@vanilla-extract/css/dist/transformCss-1e6e61bf.browser.esm.js
...
var nestingSelectorRegex = new RegExp(`(?<=^(?:[^"']|"(?:\\\\.|[^"\\\\])*"|'(?:\\\\.|[^'\\\\])*')*)&`, "g");
...
var DOUBLE_SPACE = "  ";
var specialKeys = [...simplePseudos, "@layer", "@scope", "@media", "@supports", "@container", "@starting-style", "selectors"];
var Stylesheet = class {
  constructor(localClassNames2, composedClassLists2) {
    ...
    this.composedClassLists = composedClassLists2.map((_ref) => {
      ...
      return {
        identifier,
        regex: RegExp("(".concat(escapeRegex(classList), ")"), "g")
      };
    }).reverse();
  }
  processCssObj(root) {
  ...
  transformScope(root, rules) {
    var parentConditions = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : [];
    if (rules) {
      var _this$currConditional4;
      var transformedScopeBounds = {};
      (_this$currConditional4 = this.currConditionalRuleset) === null || _this$currConditional4 === void 0 || _this$currConditional4.addConditionPrecedence(parentConditions, Object.keys(rules).map((bounds2) => {
        transformedScopeBounds[bounds2] = "@scope ".concat(this.transformSelector(bounds2.replace(nestingSelectorRegex, root.selector)));
        return transformedScopeBounds[bounds2];
      }));
      for (var [bounds, scopeRule] of Object.entries(rules)) {
        var conditions = [...parentConditions, transformedScopeBounds[bounds]];
        this.addConditionalRule({
          selector: root.selector,
  ...
  transformSupports(root, rules) {
    ...
    if (rules) {
      ...
      (_this$currConditional5 = this.currConditionalRuleset) === null || _this$currConditional5 === void 0 || _this$currConditional5.addConditionPrecedence(parentConditions, Object.keys(rules).map((query) => "@supports ".concat(query)));
  ...
  transformStartingStyle(root, rules) {
    ...
    if (rules) {
      ...
      (_this$currConditional6 = this.currConditionalRuleset) === null || _this$currConditional6 === void 0 || _this$currConditional6.addConditionPrecedence(parentConditions, ["@starting-style"]);
...
function composedStyle(rules, debugId) {
  ...
  var joinedClassList = dedupeAndJoinClassList(classList);
  if (joinedClassList.length > 0) {
    result = "".concat(className, " ").concat(joinedClassList);
    registerComposition({
